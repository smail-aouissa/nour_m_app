    ...
    <div class="col-lg-4 col-md-12">
        <div class="woocommerce-sidebar-area">
            ...
            <div class="collapse-widget collections-list-widget">
                ...
                <b-collapse :visible="!isMobile" id="collapse-2">
                    <ul class="collections-list-row">
                        <li v-for="(section, key) in sections" :key="key" :class="{'active': parseInt(type.id) === section.id }" >
            ...
            <div class="collapse-widget size-list-widget">
                ...
                <b-collapse :visible="!isMobile" id="collapse-4">
                    <ul v-if="sizes.length" class="size-list-row">
                    ...
                    <div v-else class="d-flex mt-2">Pas de tailles disponible</div>
                </b-collapse>
            </div>
            ...
            <div class="collapse-widget price-list-widget">
                ...
                <b-collapse :visible="!isMobile" id="collapse-5">
                    <div class="slider">
                        <range-slider
                                :ballWidth="20"
                                :barHeight="10"
            ...
            <div class="collapse-widget color-list-widget">
                ...
                <b-collapse :visible="!isMobile" id="collapse-6">
                    ...
                    <div v-else class="d-flex mt-2">Pas de couleurs disponible</div>
                </b-collapse>
            </div>

            <div v-if="!isMobile" class="collapse-widget aside-products-widget mb-3">
